...
echo "Welcome to the RubikWrt NanoPi R4S Update Script (Stable Firmware)"
echo "Downloading the latest release of stable firmware"
wget -P /tmp https://github.com/thomaswcy/R4S/releases/download/$(date +%Y.%m.%d)-stable/openwrt-rockchip-armv8-friendlyarm_nanopi-r4s-ext4-sysupgrade.img.gz
